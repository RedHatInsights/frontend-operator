...
| *`autocaptureAPIKey`* __string__ |
Optional autocapture analytics API key for production environments.

| *`autocaptureAPIKeyDev`* __string__ |
Optional autocapture analytics API key for development environments.
|===
