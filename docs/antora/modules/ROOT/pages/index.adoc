...
* xref:widget-registry-guide.adoc[Widget Registry Configuration Guide] - Learn how to register dashboard widgets for the HCC widget catalog

== Guides

* xref:widget-layout-templates-guide.adoc[Widget Layout Templates Guide] - Define widget registries and base dashboard layout templates for your Frontend
* xref:self-service-search.adoc[Self-Service Search Guide] - Add your frontend pages to Chrome's global search
