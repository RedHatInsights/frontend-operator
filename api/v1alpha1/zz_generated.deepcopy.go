...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AkamaiConfig) DeepCopyInto(out *AkamaiConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AkamaiConfig.
func (in *AkamaiConfig) DeepCopy() *AkamaiConfig {
	if in == nil {
		return nil
	}
	out := new(AkamaiConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FrontendEnvironmentSpec) DeepCopyInto(out *FrontendEnvironmentSpec) {
	*out = *in
	...
	if in.AkamaiConfig != nil {
		in, out := &in.AkamaiConfig, &out.AkamaiConfig
		*out = new(AkamaiConfig)
		**out = **in
	}
}
...
func (in *FrontendSpec) DeepCopyInto(out *FrontendSpec) {
	*out = *in
	...
	if in.CacheBustFiles != nil {
		in, out := &in.CacheBustFiles, &out.CacheBustFiles
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
