...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChromeNavigation) DeepCopyInto(out *ChromeNavigation) {
	*out = *in
	if in.NavItems != nil {
		in, out := &in.NavItems, &out.NavItems
		*out = make([]*ChromeNavItem, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChromeNavigation.
func (in *ChromeNavigation) DeepCopy() *ChromeNavigation {
	if in == nil {
		return nil
	}
	out := new(ChromeNavigation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *FedModule) DeepCopyInto(out *FedModule) {
	*out = *in
	if in.Config != nil {
		...
		*out = new(FedModuleConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Analytics != nil {
		in, out := &in.Analytics, &out.Analytics
		*out = new(FedModulesAnalytics)
		**out = **in
	}
	if in.Modules != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FedModuleConfig) DeepCopyInto(out *FedModuleConfig) {
	*out = *in
	if in.SSOScopes != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FedModuleConfig.
func (in *FedModuleConfig) DeepCopy() *FedModuleConfig {
	if in == nil {
		return nil
	}
	out := new(FedModuleConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FedModulesAnalytics) DeepCopyInto(out *FedModulesAnalytics) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FedModulesAnalytics.
func (in *FedModulesAnalytics) DeepCopy() *FedModulesAnalytics {
	if in == nil {
		return nil
	}
	out := new(FedModulesAnalytics)
...
func (in *FrontendSpec) DeepCopyInto(out *FrontendSpec) {
	*out = *in
	...
	if in.ChromeNavigation != nil {
		in, out := &in.ChromeNavigation, &out.ChromeNavigation
		*out = make([]*ChromeNavigation, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(ChromeNavigation)
