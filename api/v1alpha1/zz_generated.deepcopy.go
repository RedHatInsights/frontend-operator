...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionContent) DeepCopyInto(out *ExtensionContent) {
	*out = *in
	in.Module.DeepCopyInto(&out.Module)
	if in.NavItem != nil {
		in, out := &in.NavItem, &out.NavItem
		*out = new(BundleNavItem)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionContent.
func (in *ExtensionContent) DeepCopy() *ExtensionContent {
	if in == nil {
		return nil
	}
	out := new(ExtensionContent)
	in.DeepCopyInto(out)
	return out
}
